    ...
    class Logger {
        ...
        warn(...args) {
            if (this.logLevel >= LogLevel.WARN) {
                const { prefix, args: messageArgs } = this.formatMessage('WARN', ...args);
        ...
        info(...args) {
            if (this.logLevel >= LogLevel.INFO) {
                const { prefix, args: messageArgs } = this.formatMessage('INFO', ...args);
        ...
        debug(...args) {
            if (this.logLevel >= LogLevel.DEBUG) {
                const { prefix, args: messageArgs } = this.formatMessage('DEBUG', ...args);
