...
(function() {
    ...
    const visualFeedbackContent = document.getElementById('visualFeedbackContent');
    ...
    function clearVisualFeedback() {
        visualFeedbackContent.innerHTML = '<p class="empty-state">Visual analysis will appear here once video is available.</p>';
    ...
    function clearGuidance() {
        guidanceContent.innerHTML = '<p class="empty-state">Start speaking to receive guidance on your communication style.</p>';
    }
    ...
    function updateScores(scores) {
        ...
        if (scores.professionalism !== undefined) {
            ...
            professionalismBar.style.background = getScoreColor(scores.professionalism);
        }
